...
class CustomUserCreationForm(UserCreationForm):
    ...
    email = forms.EmailField(label="E-Mail", widget=forms.TextInput(attrs=input_attrs))

    input_attrs['placeholder'] = _('First Name')
    first_name = forms.CharField(label="First Name", widget=forms.TextInput(attrs=input_attrs))

    input_attrs['placeholder'] = _('Last Name')
    last_name = forms.CharField(label="Last Name", widget=forms.TextInput(attrs=input_attrs))
